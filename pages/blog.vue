<template>
  <section id="blog" class="py-2 bg-gray-50">
    <v-container>
      <div >
        <div class="text-center mb-12">
          <h1 class="text-4xl font-extrabold text-gray-900 mb-4">Blog</h1>
          <p class="text-lg text-gray-700 leading-relaxed">
            Welcome to my blog! Here you will find my latest thoughts, insights,
            and updates on web development and design.
          </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          >
            ...
            <p class="text-gray-700 mb-4">
              A brief excerpt from the blog post. This should give readers an
              idea of what the post is about and entice them to read more.
            </p>
            <nuxt-link to="#" class="text-[#B68D40] hover:underline"
              >Read More</nuxt-link
            >
          </div>

          <!-- Repeat Blog Post Item for each post -->
        </div>
      </div>
    </v-container>
  </section>
